...
```text
ProjectShortcutDock-Setup-0.1.2.exe
```
...
```text
ProjectShortcutDock-0.1.2-win-x64.zip
```
...
```powershell
.\tools\build-release.ps1 -Version 0.1.2
```

輸出檔案：

```text
artifacts\ProjectShortcutDock-Setup-0.1.2.exe
artifacts\ProjectShortcutDock-0.1.2-win-x64.zip
```
