...
```text
ProjectShortcutDock-Setup-2.1.exe
```
...
```text
ProjectShortcutDock-2.1-win-x64.zip
```
...
```text
artifacts\ProjectShortcutDock-Setup-2.1.exe
artifacts\ProjectShortcutDock-2.1-win-x64.zip
```
