...
```text
ProjectShortcutDock-Setup-0.1.4.exe
```
...
```text
ProjectShortcutDock-0.1.4-win-x64.zip
```
...
```powershell
.\tools\build-release.ps1 -Version 0.1.4
```

輸出檔案：

```text
artifacts\ProjectShortcutDock-Setup-0.1.4.exe
artifacts\ProjectShortcutDock-0.1.4-win-x64.zip
```
